...
%% API
-export([start/0,start/1,start_g/2,start/3,stop/0,put_vehicle/2]).
...
put_vehicle(Data,  PID) -> gen_server:call(PID, {put, Data}).
...
stop_test() ->
    {setup,
        ...
        [?_assertEqual(ok, gen_server:call(?MODULE, {push_info, }))]}.
